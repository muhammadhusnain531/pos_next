                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _buildSummaryRow(
                            'Opening Balance:', _currentDay!.openingBalance),
                        const Divider(),
                        _buildSummaryRow(
                            'Total Cash Sales:', _currentDay!.totalCashSales),
                        _buildSummaryRow(
                            'Total Card Sales:', _currentDay!.totalCardSales),
                        _buildSummaryRow('Total Gift Card Sales:',
                            _currentDay!.totalGiftCardSales),
                        _buildSummaryRow(
                            'Total Other Sales:', _currentDay!.totalOtherSales),
                        const Divider(),
                        _buildSummaryRow(
                          'Total Sales:',
                        ...
                        const Divider(),
                        _buildSummaryRow('Expected Cash in Drawer:',
                            _expectedCash,
                            isBold: true),
                        _buildSummaryRow(
                          'Total Expected Balance (All Modes):',
